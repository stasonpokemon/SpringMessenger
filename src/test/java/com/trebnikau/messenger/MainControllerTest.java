package com.trebnikau.messenger;

import com.trebnikau.messenger.controller.MainController;
...
@WithUserDetails(value = "admin") // аннотация для тестирования авторизированного пользователя
